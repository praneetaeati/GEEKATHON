...
<style>
	header.masthead{
		background-image: url('Copy of TRIP INDO.png');
	...
	header.masthead .container{
		background:#fff;
		padding:80px;
		background-image: url('bgindia1.jpg');
		background-repeat:no-repeat;
		background-position:50%;
	}
	header.masthead.container.masthead-subheading{
		top:10%;
	}
...
<header class="masthead">
	<div class="container">
		<div style="color:black"; "font-weight:none"; "font-size:30px";"top:0%";"position: relative"; class="masthead-subheading">Dream|explore|Discover</div>
		<div style= "color:black"; class="masthead-heading text-uppercase">Trip Indo</div>
		<a style="background-color:black";"border:none";"right:10px"; class="btn btn-primary btn-xl text-uppercase" href="#home">View Tours</a>
	</div>
</header>
<!-- Services-->
